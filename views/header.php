...
<head>
    ...
    <!--<link href="<?php echo URL; ?>views/index/css/style.css" rel="stylesheet">-->
                ...
                <ul class="nav navbar-nav navbar-right" id="test">
                    ...
                    <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown">Hi, <?php echo $_SESSION['login'];?><span class="caret"></span></a>
                        <ul class="dropdown-menu">
                            <li><a class="item" href="<?php echo URL; ?>">Home</a></li>
                            <li><a class="item" href="<?php echo URL; ?>account">Your Account</a></li>
